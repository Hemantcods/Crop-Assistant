...
export const DiagnosePage = () => {
  ...
  const diagnoseCropId = location.state?.cropId;
  ...
  const runDiagnostic = async (file) => {
    try {
      ...
      const result = await startScan(diagnoseCropId, file);
      addToast({
    ...
    <div className="flex flex-col gap-6 sm:gap-8">
      ...
      <div className="text-center lg:text-left">
        ...
        <p className="font-body-md text-body-md text-on-surface-variant text-sm sm:text-base max-w-2xl">
          Take a photo of a leaf to check for diseases. Our AI will analyze the
          image and provide a diagnosis along with actionable treatment steps.
        </p>
      </div>
          ...
          {isAnalyzing ? (
            ...
            <div className="flex flex-col items-center justify-center text-center p-6 w-full max-w-md">
              <div className="relative w-36 h-36 rounded-2xl overflow-hidden mb-6 border-2 border-primary shadow-lg bg-surface-container-high flex items-center justify-center">
                <img
                  src={
                    selectedPreset
                      ? MOCK_SAMPLE_DIAGNOSES.find(
                          (d) => d.id === selectedPreset,
                        )?.image
              ...
              <p className="text-xs text-on-surface-variant mb-5 font-medium">
                {analyzingStep === 1 &&
                  "Segmenting leaf geometry and necrotic lesions..."}
                {analyzingStep === 2 &&
                  "Matching with 50,000+ pathogen profiles in dataset..."}
                {analyzingStep === 3 &&
                  "Synthesizing precision agricultural recommendations..."}
              </p>
            ...
            <div className="border-2 border-dashed border-primary-fixed-dim rounded-2xl bg-surface-container-low hover:bg-surface-container transition-colors w-full h-full flex flex-col items-center justify-center p-6 sm:p-10 text-center">
              ...
              <p className="font-body-md text-body-md text-on-surface-variant text-xs sm:text-sm mb-6 max-w-md">
                For best results, place the affected leaf on a plain background
                and ensure it's well-lit.
              </p>
        ...
        <div className="lg:col-span-4 flex flex-col gap-4">
          <div className="bg-surface border border-outline-variant rounded-2xl p-6 shadow-[0_4px_12px_rgba(45,106,79,0.05)] h-full flex flex-col justify-between">
              ...
              <ul className="flex flex-col gap-5">
                ...
                <li className="flex items-start gap-3.5">
                  ...
                  <div>
                    ...
                    <p className="font-body-md text-xs text-on-surface-variant leading-relaxed">
                      Avoid harsh shadows or direct sunlight. Diffused, natural
                      daylight is best.
                    </p>
                  </div>
                </li>
                ...
                <li className="flex items-start gap-3.5">
                  ...
                  <div>
                    ...
                    <p className="font-body-md text-xs text-on-surface-variant leading-relaxed">
                      Ensure the image is sharp. Tap your screen to focus before
                      capturing.
                    </p>
                  </div>
                </li>
                ...
                <li className="flex items-start gap-3.5">
                  ...
                  <div>
                    ...
                    <p className="font-body-md text-xs text-on-surface-variant leading-relaxed">
                      Include the whole leaf in the frame, clearly showing both
                      healthy and diseased parts.
                    </p>
                  </div>
                </li>
              </ul>
            ...
            <div className="p-3.5 bg-surface-container-low rounded-xl border border-outline-variant/60 text-xs text-on-surface-variant mt-6">
              <span className="font-bold text-primary">AI accuracy tip:</span>{" "}
              Clean excess dirt off the leaf blade for highest confidence
              scoring.
            </div>
          </div>
        </div>
