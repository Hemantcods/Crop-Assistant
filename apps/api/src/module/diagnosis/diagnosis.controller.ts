...
export class DiagnosisController {
  ...
  saveDiagnosis = async (req: AuthRequest, res: Response) => {
    ...
    const result = await this.diagnosisService.saveDiagnosis(userId, cropId, scanId);
  ...
  getDiagnosisById = async (req: AuthRequest, res: Response) => {
    ...
    const diagnosis = await this.diagnosisService.getDiagnosisById(userId, diagnosisId);
