 ...
 * `prisma.user`: Exposes CRUD operations for the **User** model.
  ...
  */
    ...
    /**
     * `prisma.cropImage`: Exposes CRUD operations for the **CropImage** model.
      * Example usage:
      * ```ts
      * // Fetch zero or more CropImages
      * const cropImages = await prisma.cropImage.findMany()
      * ```
      */
    get cropImage(): Prisma.CropImageDelegate<ExtArgs, {
        omit: OmitOpts;
    }>;
    /**
    ...
    /**
     * `prisma.soilRecord`: Exposes CRUD operations for the **SoilRecord** model.
      * Example usage:
      * ```ts
      * // Fetch zero or more SoilRecords
      * const soilRecords = await prisma.soilRecord.findMany()
      * ```
      */
    get soilRecord(): Prisma.SoilRecordDelegate<ExtArgs, {
        omit: OmitOpts;
    }>;
    /**
    ...
    /**
     * `prisma.cropRecomendation`: Exposes CRUD operations for the **CropRecomendation** model.
      * Example usage:
      * ```ts
      * // Fetch zero or more CropRecomendations
      * const cropRecomendations = await prisma.cropRecomendation.findMany()
      * ```
      */
    get cropRecomendation(): Prisma.CropRecomendationDelegate<ExtArgs, {
        omit: OmitOpts;
    }>;
    /**
     * `prisma.cropRecomendationItem`: Exposes CRUD operations for the **CropRecomendationItem** model.
      * Example usage:
      * ```ts
      * // Fetch zero or more CropRecomendationItems
      * const cropRecomendationItems = await prisma.cropRecomendationItem.findMany()
      * ```
      */
    get cropRecomendationItem(): Prisma.CropRecomendationItemDelegate<ExtArgs, {
        omit: OmitOpts;
    }>;
    /**
     * `prisma.monitoringRecord`: Exposes CRUD operations for the **MonitoringRecord** model.
      * Example usage:
      * ```ts
      * // Fetch zero or more MonitoringRecords
      * const monitoringRecords = await prisma.monitoringRecord.findMany()
      * ```
      */
    get monitoringRecord(): Prisma.MonitoringRecordDelegate<ExtArgs, {
        omit: OmitOpts;
    }>;
    /**
