...
// @ts-nocheck 
/*
 * This file exports the `CropImage` model and its related types.
 *
...
export type GetCropImageAggregateType<T extends CropImageAggregateArgs> = {
      [P in keyof T & keyof AggregateCropImage]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateCropImage[P]>
    : Prisma.GetScalarType<T[P], AggregateCropImage[P]>
}
...
export type GetCropImageGroupByPayload<T extends CropImageGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<CropImageGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof CropImageGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], CropImageGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], CropImageGroupByOutputType[P]>
      }
    >
  >
...
export type CropImageCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<CropImageFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface CropImageDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['CropImage'], meta: { name: 'CropImage' } }
  /**
   ...
   * })
  **/
  count<T extends CropImageCountArgs>(
    args?: Prisma.Subset<T, CropImageCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], CropImageCountAggregateOutputType>
      : number
  >
  ...
  **/
  groupBy<
    T extends CropImageGroupByArgs,
  ...
  >(args: Prisma.SubsetIntersection<T, CropImageGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetCropImageGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
