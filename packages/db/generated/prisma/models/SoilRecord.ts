...
// @ts-nocheck 
/*
 * This file exports the `SoilRecord` model and its related types.
 *
...
export type GetSoilRecordAggregateType<T extends SoilRecordAggregateArgs> = {
      [P in keyof T & keyof AggregateSoilRecord]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateSoilRecord[P]>
    : Prisma.GetScalarType<T[P], AggregateSoilRecord[P]>
}
...
export type GetSoilRecordGroupByPayload<T extends SoilRecordGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<SoilRecordGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof SoilRecordGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], SoilRecordGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], SoilRecordGroupByOutputType[P]>
      }
    >
  >
...
export type SoilRecordCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<SoilRecordFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface SoilRecordDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['SoilRecord'], meta: { name: 'SoilRecord' } }
  /**
   ...
   * })
  **/
  count<T extends SoilRecordCountArgs>(
    args?: Prisma.Subset<T, SoilRecordCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], SoilRecordCountAggregateOutputType>
      : number
  >
  ...
  **/
  groupBy<
    T extends SoilRecordGroupByArgs,
  ...
  >(args: Prisma.SubsetIntersection<T, SoilRecordGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetSoilRecordGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
