...
// @ts-nocheck 
/*
 * This file exports the `CropRecomendation` model and its related types.
 *
...
export type GetCropRecomendationAggregateType<T extends CropRecomendationAggregateArgs> = {
      [P in keyof T & keyof AggregateCropRecomendation]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateCropRecomendation[P]>
    : Prisma.GetScalarType<T[P], AggregateCropRecomendation[P]>
}
...
export type GetCropRecomendationGroupByPayload<T extends CropRecomendationGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<CropRecomendationGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof CropRecomendationGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], CropRecomendationGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], CropRecomendationGroupByOutputType[P]>
      }
    >
  >
...
export type CropRecomendationCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<CropRecomendationFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface CropRecomendationDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['CropRecomendation'], meta: { name: 'CropRecomendation' } }
  /**
   ...
   * })
  **/
  count<T extends CropRecomendationCountArgs>(
    args?: Prisma.Subset<T, CropRecomendationCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], CropRecomendationCountAggregateOutputType>
      : number
  >
  ...
  **/
  groupBy<
    T extends CropRecomendationGroupByArgs,
  ...
  >(args: Prisma.SubsetIntersection<T, CropRecomendationGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetCropRecomendationGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
