...
// @ts-nocheck 
/*
 * This file exports the `CropRecomendationItem` model and its related types.
 *
...
export type GetCropRecomendationItemAggregateType<T extends CropRecomendationItemAggregateArgs> = {
      [P in keyof T & keyof AggregateCropRecomendationItem]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateCropRecomendationItem[P]>
    : Prisma.GetScalarType<T[P], AggregateCropRecomendationItem[P]>
}
...
export type GetCropRecomendationItemGroupByPayload<T extends CropRecomendationItemGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<CropRecomendationItemGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof CropRecomendationItemGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], CropRecomendationItemGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], CropRecomendationItemGroupByOutputType[P]>
      }
    >
  >
...
export type CropRecomendationItemCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<CropRecomendationItemFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface CropRecomendationItemDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['CropRecomendationItem'], meta: { name: 'CropRecomendationItem' } }
  /**
   ...
   * })
  **/
  count<T extends CropRecomendationItemCountArgs>(
    args?: Prisma.Subset<T, CropRecomendationItemCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], CropRecomendationItemCountAggregateOutputType>
      : number
  >
  ...
  **/
  groupBy<
    T extends CropRecomendationItemGroupByArgs,
  ...
  >(args: Prisma.SubsetIntersection<T, CropRecomendationItemGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetCropRecomendationItemGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
